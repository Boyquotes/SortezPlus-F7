...
$req = $dbh->prepare("SELECT * FROM sortezplbdd.sp_posts INNER JOIN sortezplbdd.sp_postmeta ON sortezplbdd.sp_posts.id = sortezplbdd.sp_postmeta.post_id where sortezplbdd.sp_posts.post_type = 'ait-dir-item' AND sortezplbdd.sp_postmeta.meta_key = '_ait-dir-item';");
$req->execute();
$i=0;
